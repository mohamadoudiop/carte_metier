    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Renouveler carte</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="tableau_de_bord.php">Tableau de bord</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Renouveler carte</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <?php
                            if ($result2 && $result2->num_rows > 0) {
                                ...
                                while ($row = $result2->fetch_assoc()) {
                                    ...
                                    // Colonne "Renouvellement" avec lien vers la page renouvellement.php
                                    echo "<td><a class='badge-link' href='renouv.php?idCarteMareyeur=" . $row['idCarteMareyeur'] . "'><span class='btn btn-primary'>Renouveler</span></a></td>";
                                    echo "</tr>";
                                }
                            } else {
