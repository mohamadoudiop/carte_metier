<?php
    ...
    // Requête SQL pour récupérer les données des cartes et des personnes liées
    $sql2 = "SELECT e.idEntreprise, e.Denomination, e.NumRegistreCom, e.RegionEntreprise, e.DepartementEntreprise, e.PhoneEntreprise,
                    p.NomPersonne, p.PrenomPersonne, p.DateNaissance, p.CNI, p.Genre, p.PhonePersonne
            FROM Entreprise e
    ...
    if (isset($_POST['search_numero_carte'])) {
        ...
        // Ajouter une clause WHERE à la requête SQL pour rechercher le numéro de carte spécifique
        $sql2 .= " WHERE cm.NumeroCarte = '$search_numero_carte'";
    }
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Saisie autre carte</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="tableau_de_bord.php">Tableau de bord</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Saisie autre carte</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        if ($result2 && $result2->num_rows > 0) {
                            ...
                            while ($row = $result2->fetch_assoc()) {
                                ...
                                echo "<td>" . $row['DepartementEntreprise'] . "</td>";
                                echo "<td>" . $row['PhoneEntreprise'] . "</td>";
                                // Colonne "Ajouter" avec lien vers la page d'ajout d'une autre carte
                                echo "<td><a class='badge-link' href='impressionAutreCarte.php?idEntreprise=" . $row['idEntreprise'] . "'><span class='btn btn-success'>Ajouter</span></a></td>";
                                echo "</tr>";
                            }
                        } else {
