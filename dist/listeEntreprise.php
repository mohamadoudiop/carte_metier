<?php
    ...
    $sql2 = "SELECT cm.idCarteMareyeur, cm.NumeroCarte, cm.LibelleCategorie, cm.NumQuitance, cm.DateDebutValid, cm.Siege,
                    ...
                    e.NumRegistreCom, e.RegionEntreprise, e.DepartementEntreprise
...
<head>
    ...
    <title>Liste des GIE - Gestion des cartes de mareyeur</title>
...
<div class="main-content container-fluid">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Liste des GIE</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <form action="export_entreprise.php" method="post">
                <div class="card-body">
                    <button type="submit" name="export_entreprise" class="btn waves-effect waves-light btn-primary">Exporter</button>
