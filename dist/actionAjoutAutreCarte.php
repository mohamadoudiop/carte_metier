<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if(isset($_POST["numeroCarte"], $_POST["idEntreprise"], $_POST["numQuitance"], $_POST["dateQuitance"], $_POST["dateDebutValid"], $_POST["dateFinValid"], $_POST["siege"], $_POST["categorie"], $_POST["montantCategorie"])){
            $conn = connexion_base();
            ...
            $idEntreprise = mysqli_real_escape_string($conn, $_POST["idEntreprise"]);

            // Insertion dans la table "cartemareyeur"
            $queryCarteMareyeur = "INSERT INTO cartemareyeur (NumeroCarte, idEntreprise, LibelleCategorie, MontantCategorie, NumQuitance, DateQuitance, DateDebutValid, DateFinValid, Siege) VALUES ('$numeroCarte', '$idEntreprise', '$libelleCategorie', $montantCategorie, '$numQuitance', '$dateQuitance', '$dateDebutValid', '$dateFinValid', '$siege')";
