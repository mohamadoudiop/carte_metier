...
<head>
    ...
    <title>Suppression de carte - Gestion des cartes de mareyeur</title>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Suppression de carte</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="tableau_de_bord.php">Tableau de bord</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Suppression de carte</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <?php
                            if ($result2 && $result2->num_rows > 0) {
                                ...
                                while ($row = $result2->fetch_assoc()) {
                                    ...
                                    // Colonne "Supprimer" avec lien pour la suppression
                                    echo "<td><a class='badge-link' href='actionSupprimerCarte.php?idCarteMareyeur=" . $row['idCarteMareyeur'] . "'><span class='btn btn-danger'>Supprimer</span></a></td>";
                                    echo "</tr>";
                                }
                            } else {
